       ...
       //CmsNews
        ...
        $(".menu").on("click", ".alert_warning", function () {
            ...
            swal({
                ...
                $.ajax({
                    url: "/SysMenu/Delete/" + button.attr("data-menu-id"),
                    method: "DELETE",
                    success: function () {
                        table.row(button.parents("tr")).remove().draw();
                    }
        ...
        $(".cms_menu").on("click", ".alert_warning", function () {
            var button = $(this);
            swal({
                title: "Are you sure?",
                text: "You will not be able to recover this imaginary file!",
                ...
                closeOnConfirm: false,
                    ...
                    console.log(button.attr("data-cmsmenu-id"));
                $.ajax({
                    url: "/Menu/Delete/" + button.attr("data-cmsmenu-id"),
                    method: "DELETE",
                    success: function () {
                        table.row(button.parents("tr")).remove().draw();
                    }
        ...
        $(".datatable10").on("click", ".alert_warning", function () {
            ...
            swal({
                ...
                $.ajax({
                    url: "/AllCategory/Delete/" + button.attr("data-allcategory-id"),
                    method: "DELETE",
                    success: function () {
                        table.row(button.parents("tr")).remove().draw();
                    }
